...
<?php include('header.php') ?>
    ...
    <div class="about-wthree" id="about">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-5 about-right-bg" data-aos="zoom-out" data-aos-delay="100" ></div>
                <div class="col-lg-7 about-left-wthree bg-theme"  style="overflow:hidden;" data-blast="bgColor">
                    <div class="title-desc text-right pb-sm-3 wow bounceIn animated  " data-aos="fade-left" data-aos-delay="500"  >
                        <h3 class="main-title-w3pvt text-white text-capitalize ">WELCOME TO ADVANCE SCIENTIFIC AND SURGICAL CO.</h3>
                        <p class="text-white"></p>
                    </div>
                    <p data-aos="fade-down" data-aos-delay="500"class="my-3 text-right text-white child_second wow bounceIn animated "  data-wow-duration="2s" data-wow-delay="2s" >
                    ...
                    <div  data-aos="fade-right" data-aos-delay="500"class="ml-auto text-right">
                        <a href="about.php" class="text-capitalize text-dark w3_pvt-link-bnr btn bg-light mt-sm-4">view
                            more</a>
                    </div>
                </div>
